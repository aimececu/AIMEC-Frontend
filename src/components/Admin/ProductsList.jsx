  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-0">
        ...
        <Button onClick={onAddProduct} size="sm" className="flex items-center gap-2 w-full sm:w-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-6">
        {currentProducts.map((product) => (
          <Card
            key={product.id}
            className="p-4 sm:p-6 hover:shadow-lg transition-all duration-200 hover:-translate-y-1 flex flex-col h-full"
          >
            {/* Contenido principal */}
            <div className="flex-1">
              ...
              <div className="flex items-start gap-3 sm:gap-4 mb-3 sm:mb-4">
                <div className="relative flex-shrink-0">
                  <ImageWithFallback
                    ...
                    alt={product.name}
                    className="w-16 h-16 sm:w-24 sm:h-24 object-cover rounded-lg border border-secondary-200 dark:border-secondary-700"
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="font-semibold text-secondary-900 dark:text-white text-sm sm:text-base mb-1 line-clamp-2">
                    {product.name}
                  </h3>
              ...
              <div className="flex items-baseline gap-2 mb-3 sm:mb-4">
                ...
                {product.originalPrice &&
                  product.originalPrice !== product.price && (
                    <span className="text-sm sm:text-lg text-secondary-400 line-through">
                      ${product.originalPrice}
                    </span>
                  )}
              </div>
              ...
              {/* Descripción */}
              {product.description && (
                <p className="text-xs sm:text-sm text-secondary-600 dark:text-secondary-400 mb-3 sm:mb-4 line-clamp-2">
                  {product.description}
                </p>
              )}
            ...
            <div className="flex items-center gap-2 pt-3 sm:pt-4 border-t border-secondary-200 dark:border-secondary-700 mt-auto">
              <Button
                variant="outline"
                size="sm"
                onClick={() => onEditProduct(product)}
                className="flex items-center gap-1 sm:gap-2 flex-1 border-blue-600 text-blue-600 hover:bg-blue-50 hover:text-blue-700 dark:border-blue-400 dark:text-blue-400 dark:hover:bg-blue-900/20 dark:hover:text-blue-300 text-xs sm:text-sm"
              >
              ...
              <Button
                ...
                className="flex items-center gap-1 sm:gap-2 border-red-600 text-red-600 hover:bg-red-50 hover:text-red-700 dark:border-red-400 dark:text-red-400 dark:hover:bg-red-900/20 dark:hover:text-red-300 text-xs sm:text-sm"
              >
                ...
                {Array.from({ length: totalPages }, (_, index) => {
                  ...
                  if (
                    ...
                    return (
                      <span
                        key={pageNumber}
                        className="px-1 sm:px-2 text-secondary-400 text-xs sm:text-sm"
                      >
                        ...
                      </span>
                    );
      ...
      {filteredProducts.length === 0 && (
        <Card className="p-8 sm:p-12 text-center">
          <Icon
            name="FiPackage"
            className="text-4xl sm:text-6xl text-secondary-400 mx-auto mb-4 sm:mb-6"
          />
