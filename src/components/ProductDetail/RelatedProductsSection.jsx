    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <span className="text-sm text-secondary-500 dark:text-secondary-400">
          ({relatedProducts.length} producto
          {relatedProducts.length !== 1 ? "s" : ""} en{" "}
          {Object.keys(groupedRelatedProducts).length} categoría
          {Object.keys(groupedRelatedProducts).length !== 1 ? "s" : ""})
        </span>
      </div>
          ...
          <div key={relationshipType} className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-secondary-600 dark:text-secondary-400 text-sm">
                ...
                relacionado{products.length !== 1 ? "s" : ""}
              </span>
            </div>
